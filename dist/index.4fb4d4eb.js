...
btn.addEventListener('click', ()=>{
    if (btn.style.animationDirection == "normal") btn.style.animationDirection = "reverse";
    else btn.style.animationDirection = "normal";
});

//# sourceMappingURL=index.4fb4d4eb.js.map
